...
export default function FiltrosSalidas({ defaults }: Props) {
  ...
  function handleBuscar(e: React.FormEvent) {
    e.preventDefault();
    startTransition(() => router.push(`/ordenes?${buildParams({ page: "1" })}`));
  }
  ...
  function handleLimpiar() {
    ...
    setDesde("");
    setHasta("");
    startTransition(() => router.push("/ordenes"));
  }
    ...
    >
      <div>
        ...
        <input
          ...
          placeholder="N° de orden, cliente, marca, modelo o N° de serie..."
          className={inputCls}
          autoFocus
        />
      </div>
