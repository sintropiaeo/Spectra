...
export default function FiltrosIngresos({ defaults }: Props) {
  ...
  function buildParams(overrides: Record<string, string> = {}) {
    ...
    const all: Record<string, string> = { q, desde, hasta, ...overrides };
  ...
  function handleBuscar(e: React.FormEvent) {
    e.preventDefault();
    startTransition(() => router.push(`/ingresos?${buildParams({ page: "1" })}`));
  }
  ...
  function handleLimpiar() {
    ...
    setDesde("");
    setHasta("");
    startTransition(() => router.push("/ingresos"));
  }
    ...
    >
      <div>
        ...
        <input
          ...
          placeholder="N° de entrada, cliente, marca, modelo o N° de serie..."
          className={inputCls}
          autoFocus
        />
      </div>
