...
export default function FiltrosRemitos({ defaults }: Props) {
  ...
  function handleBuscar(e: React.FormEvent) {
    e.preventDefault();
    startTransition(() => router.push(`/remitos?${buildParams({ page: "1" })}`));
  }
  ...
  function handleLimpiar() {
    ...
    setDesde("");
    setHasta("");
    startTransition(() => router.push("/remitos"));
  }
    ...
    >
      <div>
        ...
        <input
          ...
          placeholder="Nombre de cliente, CUIT o N° de remito físico..."
          className={inputCls}
          autoFocus
        />
      </div>
